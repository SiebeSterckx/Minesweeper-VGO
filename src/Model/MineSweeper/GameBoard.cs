...
namespace Model.MineSweeper
{
    internal class GameBoard : IGameBoard
    {
        ...
        public const double MaxMineProbability = 1.1;
        public const double MinMineProbability = 0.1;
        ...
        public static GameBoard CreateRandom( int width, int height, int seed, double mineProbability )
        {
            ...
            else if ( mineProbability < MinMineProbability || mineProbability > MaxMineProbability)
            {
